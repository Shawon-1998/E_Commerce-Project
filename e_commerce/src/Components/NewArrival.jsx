  ...
  return (
    <>
      <div className="container ">
        ...
        />
        <div className=' grid-main md:grid md:grid-cols-[50%_auto_auto_auto] md:gap-5  text-white flex flex-col gap-5 '>
          <div className=' w-full bg-[url(assets/Frame1.png)] bg-no-repeat bg-center bg-cover rounded-sm'>
            <NewArrivalCard
          ...
          <div className='  bg-[url(assets/Frame3.png)] bg-no-repeat bg-center bg-cover rounded-sm'>
            <NewArrivalCard
          ...
          <div className=' rounded-sm bg-[url(assets/Frame4.png)] bg-no-repeat bg-center bg-cover '>
            <NewArrivalCard
